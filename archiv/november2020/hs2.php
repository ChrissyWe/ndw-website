    ...
    <div class="container-fluid">
        <div class="row text-center">
            ...
            <h1 class="largeHeadline">Nacht der Wissenschaft<br>
                Online Hörsaal 2 </h1>
                <p style="text-align:center"><iframe width="560" height="315" src="https://www.youtube.com/embed/Pt1Axyv3UYY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
        </div>
    </div>
    <div class="container">
    <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne11" class="panel-collapse collapse question">
                          ...
                          <button class="btn btn-success"
                                  onclick="send('collapseOne11', 'https://uqudy.serpens.uberspace.de/helpers/ndw2/write.php')">Absenden</button></div>
                            </div>
                        </div>
                    </div>
                </div>
